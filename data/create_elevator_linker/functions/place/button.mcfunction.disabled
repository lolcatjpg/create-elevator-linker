...
# create button
execute at @s align xyz positioned ~.5 ~ ~.5 as @e[type=glow_item_frame, distance=..1, limit=1] unless score @p create_elevator_linker.placing_elevator_id matches 0 unless entity @e[type=armor_stand, distance=..0.5] run function src_create_elevator_linker:component/button/init
